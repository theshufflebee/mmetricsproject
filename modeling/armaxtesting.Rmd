...
res.old = armax(armax_data$SPY_vol,xreg=armax_data$total_tariff,nb.lags=5,
                latex=F,max.p = 5, max.q = 5)
...
IRF = cbind.data.frame(1:nb.periods,IRFdata,IRFdata2)
colnames(IRF) = c("Period","IRF","IRF2")

ggplot(IRF,aes(x = Period, y = IRFdata2)) +
    geom_line(color = "steelblue", size = 1.2) +
    geom_point(color = "red", size = 2) +
    labs(title = "OLS IRF 1") +
    theme_minimal()
