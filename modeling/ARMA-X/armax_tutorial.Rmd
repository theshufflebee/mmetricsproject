...
#select timeframe 
SPY = filter(SPY,between(timestamp, as.Date('2025-01-01'), as.Date('2025-05-07')))
VGK = filter(VGK,between(timestamp, as.Date('2025-01-01'), as.Date('2025-05-07')))
ASHR = filter(ASHR,between(timestamp, as.Date('2025-01-01'), as.Date('2025-05-07')))
social = filter(social,between(timestamp, as.Date('2025-01-01'), as.Date('2025-05-07')))
social_hourly = filter(social_hourly,between(timestamp, as.Date('2025-01-01'), as.Date('2025-05-07')))
