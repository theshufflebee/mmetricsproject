...
checkresiduals(dummy_fit$model)$statistic
checkresiduals(count_fit$model)$statistic
checkresiduals(tariff_fit$model)$statistic
checkresiduals(trade_fit$model)$statistic
checkresiduals(china_fit$model)$statistic
checkresiduals(positive_fit$model)$statistic
checkresiduals(negative_fit$model)$statistic
