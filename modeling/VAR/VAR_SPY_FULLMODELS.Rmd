...
ggplot(Yd,aes(x=period, y=response)) +
  ...
  geom_line() +
  theme_light() +
  ggtitle("IRF of Dummy on Volatility")+
  ylab("")+
  xlab("") +
  theme_minimal()
...
ggplot(Yd,aes(x=period, y=cumsum(response))) +
  ...
  geom_line() +
  theme_light() +
  ggtitle("Cumumalitve IRF of Dummy on Volatility") +
  ylab("")+
  xlab("") +
  theme_minimal()
```
...
ggplot(Yd2,aes(x=period, y=response)) +
  ...
  geom_line() +
  theme_light() +
  ggtitle("IRF of N on Volatility") +
  ylab("")+
  xlab("") +
  theme_minimal()
```
...
ggplot(Yd2,aes(x=period, y=cumsum(response))) +
  ...
  geom_line() +
  theme_light() +
  ggtitle("Cumumalitve IRF of N on Volatility") +
  ylab("")+
  xlab("") +
  theme_minimal()
```
...
ggplot(Yd3,aes(x=period, y=response)) +
  ...
  geom_line() +
  theme_light() +
  ggtitle("IRF of tariff on Volatility") +
  ylab("")+
  xlab("") +
  theme_minimal()
```
...
ggplot(Yd3,aes(x=period, y=cumsum(response))) +
  ...
  geom_line() +
  theme_light() +
  ggtitle("Cumumalitve IRF of tariff on Volatility") +
  ylab("")+
  xlab("") +
  theme_minimal()
```
...
ggplot(Yd4,aes(x=period, y=response)) +
  ...
  geom_line() +
  theme_light() +
  ggtitle("IRF of Trade on Volatility") +
  ylab("")+
  xlab("") +
  theme_minimal()
```
...
ggplot(Yd4,aes(x=period, y=cumsum(response))) +
  ...
  geom_line() +
  theme_light() +
  ggtitle("Cumumalitve IRF of trade on Volatility") +
  ylab("")+
  xlab("") +
  theme_minimal()
```
...
ggplot(Ydchina,aes(x=period, y=response)) +
  ...
  geom_line() +
  theme_light() +
  ggtitle("IRF of China on Volatility") +
  ylab("")+
  xlab("") +
  theme_minimal()
```
...
ggplot(Ydchina,aes(x=period, y=cumsum(response))) +
  ...
  geom_line() +
  theme_light() +
  ggtitle("Cumumalitve IRF of China on Volatility") +
  ylab("")+
  xlab("") +
  theme_minimal()
```
...
```{r estime positive }
y5 = cbind(Vdata$prop_positive, Vdata$SPY_vol)
...
ggplot(Yd5,aes(x=period, y=response)) +
  ...
  geom_line() +
  theme_light() +
  ggtitle("IRF of Positive on Volatility") +
  ylab("")+
  xlab("") +
  theme_minimal()
```
...
ggplot(Yd5,aes(x=period, y=cumsum(response))) +
  ...
  geom_line() +
  theme_light() +
  ggtitle("Cumumalitve IRF of Positive on Volatility") +
  ylab("")+
  xlab("") +
  theme_minimal()
```
...
```{r estimate negative}
y6 = cbind(Vdata$prop_negative, Vdata$SPY_vol)
...
ggplot(Yd6,aes(x=period, y=response)) +
  ...
  geom_line() +
  theme_light() +
  ggtitle("IRF of Negative on Volatility") +
  ylab("")+
  xlab("") +
  theme_minimal()
```
...
ggplot(Yd6,aes(x=period, y=cumsum(response))) +
  ...
  geom_line() +
  theme_light() +
  ggtitle("Cumumalitve IRF of Negative on Volatility") +
  ylab("")+
  xlab("") +
  theme_minimal()
```
...
```{r estimate truste}
y7 = cbind(Vdata$prop_trust, Vdata$SPY_vol)
...
ggplot(Yd7,aes(x=period, y=response)) +
  ...
  geom_line() +
  theme_light() +
  ggtitle("IRF of Trust on Volatility") +
  ylab("")+
  xlab("") +
  theme_minimal()
```
...
ggplot(Yd7,aes(x=period, y=cumsum(response))) +
  ...
  geom_line() +
  theme_light() +
  ggtitle("Cumumalitve IRF of Trust on Volatility") +
  ylab("")+
  xlab("") +
  theme_minimal()
```
...
```{r estimate surprise}
y8 = cbind(Vdata$prop_surprise, Vdata$SPY_vol)
...
ggplot(Yd8,aes(x=period, y=response)) +
  ...
  geom_line() +
  theme_light() +
  ggtitle("IRF of Surprise on Volatility") +
  ylab("")+
  xlab("") +
  theme_minimal()
```
...
ggplot(Yd8,aes(x=period, y=cumsum(response))) +
  ...
  geom_line() +
  theme_light() +
  ggtitle("Cumumalitve IRF of Surprise on Volatility") +
  ylab("")+
  xlab("") +
  theme_minimal()
```
...
```{r estimate sadness}
y9 = cbind(Vdata$prop_sadness, Vdata$SPY_vol)
...
ggplot(Yd9,aes(x=period, y=response)) +
  ...
  geom_line() +
  theme_light() +
  ggtitle("IRF of Sadness on Volatility") +
  ylab("")+
  xlab("") +
  theme_minimal()
```
...
ggplot(Yd9,aes(x=period, y=cumsum(response))) +
  ...
  geom_line() +
  theme_light() +
  ggtitle("Cumumalitve IRF of Sadness on Volatility") +
  ylab("")+
  xlab("") +
  theme_minimal()
```
...
```{r estimate joy}
y10 = cbind(Vdata$prop_joy, Vdata$SPY_vol)
...
ggplot(Yd10,aes(x=period, y=response)) +
  ...
  geom_line() +
  theme_light() +
  ggtitle("IRF of Joy on Volatility") +
  ylab("")+
  xlab("") +
  theme_minimal()
```
...
ggplot(Yd10,aes(x=period, y=cumsum(response))) +
  ...
  geom_line() +
  theme_light() +
  ggtitle("Cumumalitve IRF of Joy on Volatility") +
  ylab("")+
  xlab("") +
  theme_minimal()
```
...
```{r estimate fear}
y32 = cbind(Vdata$prop_fear, Vdata$SPY_vol)
...
ggplot(Yd32,aes(x=period, y=response)) +
  ...
  geom_line() +
  theme_light() +
  ggtitle("IRF of Fear on Volatility") +
  ylab("")+
  xlab("") +
  theme_minimal()
```
...
ggplot(Yd32,aes(x=period, y=cumsum(response))) +
  ...
  geom_line() +
  theme_light() +
  ggtitle("Cumumalitve IRF of Fear on Volatility") +
  ylab("")+
  xlab("") +
  theme_minimal()
```
...
```{r estimate disgust}
y11 = cbind(Vdata$prop_disgust, Vdata$SPY_vol)
...
ggplot(Yd11,aes(x=period, y=response)) +
  ...
  geom_line() +
  theme_light() +
  ggtitle("IRF of Disgust on Volatility") +
  ylab("")+
  xlab("") +
  theme_minimal()
```
...
ggplot(Yd11,aes(x=period, y=cumsum(response))) +
  ...
  geom_line() +
  theme_light() +
  ggtitle("Cumumalitve IRF of Disgust on Volatility") +
  ylab("")+
  xlab("") +
  theme_minimal()
```
...
y15 = cbind(Vdata$prop_anticipation, Vdata$SPY_vol)
...
ggplot(Yd15,aes(x=period, y=response)) +
  ...
  geom_line() +
  theme_light() +
  ggtitle("IRF of Anticipation on Volatility") +
  ylab("")+
  xlab("") +
  theme_minimal()
```
...
ggplot(Yd15,aes(x=period, y=cumsum(response))) +
  ...
  geom_line() +
  theme_light() +
  ggtitle("Cumumalitve IRF of Anticipation on Volatility") +
  ylab("")+
  xlab("") +
  theme_minimal()
```
...
```{r estimate anger}
y16 = cbind(Vdata$prop_anger, Vdata$SPY_vol)
...
ggplot(Yd16,aes(x=period, y=response)) +
  ...
  geom_line() +
  theme_light() +
  ggtitle("IRF of Anger on Volatility") +
  ylab("")+
  xlab("") +
  theme_minimal()
```
...
ggplot(Yd16,aes(x=period, y=cumsum(response))) +
  ...
  geom_line() +
  theme_light() +
  ggtitle("Cumumalitve IRF of Anger on Volatility") +
  ylab("")+
  xlab("") +
  theme_minimal()
```
...
ggplot(Yd12,aes(x=period, y=response)) +
  ...
  geom_line() +
  theme_light() +
  ggtitle("IRF of N*Tariff on Volatility") +
  ylab("")+
  xlab("") +
  theme_minimal()
```
...
ggplot(Yd12,aes(x=period, y=cumsum(response))) +
  ...
  geom_line() +
  theme_light() +
  ggtitle("Cumumalitve IRF of N*tariff on Volatility") +
  ylab("")+
  xlab("") +
  theme_minimal()
```
...
ggplot(Yd14,aes(x=period, y=response)) +
  ...
  geom_line() +
  theme_light() +
  ggtitle("IRF of N*Trade on Volatility") +
  ylab("")+
  xlab("") +
  theme_minimal()
```
...
ggplot(Yd14,aes(x=period, y=cumsum(response))) +
  ...
  geom_line() +
  theme_light() +
  ggtitle("Cumumalitve IRF of N*Trade on Volatility") +
  ylab("")+
  xlab("") +
  theme_minimal()
```
...
ggplot(Yd_f_d,aes(x=period, y=response)) +
  ...
  geom_line() +
  theme_light() +
  ggtitle("IRF of First Term Dummy on Volatility") +
  ylab("")+
  xlab("") +
  theme_minimal()
```
...
ggplot(Yd_f_d,aes(x=period, y=cumsum(response))) +
  ...
  geom_line() +
  theme_light() +
  ggtitle("Cumumalitve IRF of First Mandate Dummy on Volatility") +
  ylab("")+
  xlab("") +
  theme_minimal()
```
...
ggplot(Yd_f_n,aes(x=period, y=response)) +
  ...
  geom_line() +
  theme_light() +
  ggtitle("IRF of First Term N on Volatility") +
  ylab("")+
  xlab("") +
  theme_minimal()
```
...
ggplot(Yd_f_n,aes(x=period, y=cumsum(response))) +
  ...
  geom_line() +
  theme_light() +
  ggtitle("Cumumalitve IRF of First Mandate N on Volatility") +
  ylab("")+
  xlab("") +
  theme_minimal()
```
...
ggplot(Yd_f_ta,aes(x=period, y=response)) +
  ...
  geom_line() +
  theme_light() +
  ggtitle("IRF of First Term Tariff on Volatility") +
  ylab("")+
  xlab("") +
  theme_minimal()
```
...
ggplot(Yd_f_ta,aes(x=period, y=cumsum(response))) +
  ...
  geom_line() +
  theme_light() +
  ggtitle("Cumumalitve IRF of First Mandate Tariff on Volatility") +
  ylab("")+
  xlab("") +
  theme_minimal()
```
...
ggplot(Yd_f_tr,aes(x=period, y=response)) +
  ...
  geom_line() +
  theme_light() +
  ggtitle("IRF of First Term Trade on Volatility") +
  ylab("")+
  xlab("") +
  theme_minimal()
```
...
ggplot(Yd_f_tr,aes(x=period, y=cumsum(response))) +
  ...
  geom_line() +
  theme_light() +
  ggtitle("Cumumalitve IRF of First Mandate Trade on Volatility") +
  ylab("")+
  xlab("") +
  theme_minimal()
```
...
ggplot(Yd_f_ch,aes(x=period, y=response)) +
  ...
  geom_line() +
  theme_light() +
  ggtitle("IRF of First Term China on Volatility") +
  ylab("")+
  xlab("") +
  theme_minimal()
```
...
ggplot(Yd_f_ch,aes(x=period, y=cumsum(response))) +
  ...
  geom_line() +
  theme_light() +
  ggtitle("Cumumalitve IRF of First Mandate China on Volatility") +
  ylab("")+
  xlab("") +
  theme_minimal()
```
...
ggplot(Yd_s_d,aes(x=period, y=response)) +
  ...
  geom_line() +
  theme_light() +
  ggtitle("IRF of Second Term Dummy on Volatility") +
  ylab("")+
  xlab("") +
  theme_minimal()
```
...
ggplot(Yd_s_d,aes(x=period, y=cumsum(response))) +
  ...
  geom_line() +
  theme_light() +
  ggtitle("Cumumalitve IRF of Second Mandate Dummy on Volatility") +
  ylab("")+
  xlab("") +
  theme_minimal()
```
...
ggplot(Yd_s_n,aes(x=period, y=response)) +
  ...
  geom_line() +
  theme_light() +
  ggtitle("IRF of Second Term N on Volatility") +
  ylab("")+
  xlab("") +
  theme_minimal()
```
...
ggplot(Yd_s_n,aes(x=period, y=cumsum(response))) +
  ...
  geom_line() +
  theme_light() +
  ggtitle("Cumumalitve IRF of Second Mandate N on Volatility") +
  ylab("")+
  xlab("") +
  theme_minimal()
```
...
ggplot(Yd_s_ta,aes(x=period, y=response)) +
  ...
  geom_line() +
  theme_light() +
  ggtitle("IRF of Second Term Tariff on Volatility") +
  ylab("")+
  xlab("") +
  theme_minimal()
```
...
ggplot(Yd_s_ta,aes(x=period, y=cumsum(response))) +
  ...
  geom_line() +
  theme_light() +
  ggtitle("Cumumalitve IRF of Second Mandate Tariff on Volatility") +
  ylab("")+
  xlab("") +
  theme_minimal()
```
...
ggplot(Yd_s_tr,aes(x=period, y=response)) +
  ...
  geom_line() +
  theme_light() +
  ggtitle("IRF of Second Term Trade on Volatility") +
  ylab("")+
  xlab("") +
  theme_minimal()
```
...
ggplot(Yd_s_tr,aes(x=period, y=cumsum(response))) +
  ...
  geom_line() +
  theme_light() +
  ggtitle("Cumumalitve IRF of Second Mandate Trade on Volatility") +
  ylab("")+
  xlab("") +
  theme_minimal()
```
...
ggplot(Yd_s_ch,aes(x=period, y=response)) +
  ...
  geom_line() +
  theme_light() +
  ggtitle("IRF of Second Term China on Volatility") +
  ylab("")+
  xlab("") +
  theme_minimal()
```
...
ggplot(Yd_s_ch,aes(x=period, y=cumsum(response))) +
  ...
  geom_line() +
  theme_light() +
  ggtitle("Cumumalitve IRF of Second Term China on Volatility") +
  ylab("")+
  xlab("") +
  theme_minimal()
```
