...
During our analysis, we conducted several tests for serial correlation to assess
whether the error terms of our estimations exhibit serial correlation and/or 
heteroskedasticity
...
hete = arch.test(est.VAR3, lags.multi = 80, multivariate.only = TRUE)
hete
