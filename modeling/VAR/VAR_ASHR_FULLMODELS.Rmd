...
```{r estime tariff}
y3 = cbind(Vdata$tariff, Vdata$ASHR_vol)
...
ggplot(Yd3,aes(x=period, y=response)) +
  ...
  geom_line() +
  theme_light() +
  ggtitle("ASHR IRF of tariff on Volatility") +
  ylab("")+
  xlab("") +
  theme_minimal()
```
...
ggplot(Yd3,aes(x=period, y=cumsum(response))) +
  ...
  geom_line() +
  theme_light() +
  ggtitle("ASHR Cumulalitve IRF of tariff on Volatility") +
  ylab("")+
  xlab("") +
  theme_minimal()
```
...
```{r estime positive }
y5 = cbind(Vdata$prop_positive, Vdata$ASHR_vol)
...
ggplot(Yd5,aes(x=period, y=response)) +
  ...
  geom_line() +
  theme_light() +
  ggtitle("ASHR IRF of Positive on Volatility") +
  ylab("")+
  xlab("") +
  theme_minimal()
```
...
ggplot(Yd5,aes(x=period, y=cumsum(response))) +
  ...
  geom_line() +
  theme_light() +
  ggtitle("ASHR Cumulalitve IRF of Positive on Volatility") +
  ylab("")+
  xlab("") +
  theme_minimal()
```
...
```{r estimate negative}
y6 = cbind(Vdata$prop_negative, Vdata$ASHR_vol)
...
ggplot(Yd6,aes(x=period, y=response)) +
  ...
  geom_line() +
  theme_light() +
  ggtitle("ASHR IRF of Negative on Volatility") +
  ylab("")+
  xlab("") +
  theme_minimal()
```
...
ggplot(Yd6,aes(x=period, y=cumsum(response))) +
  ...
  geom_line() +
  theme_light() +
  ggtitle("ASHR Cumulalitve IRF of Negative on Volatility") +
  ylab("")+
  xlab("") +
  theme_minimal()
```
...
```{r estimate truste}
y7 = cbind(Vdata$prop_trust, Vdata$ASHR_vol)
...
ggplot(Yd7,aes(x=period, y=response)) +
  ...
  geom_line() +
  theme_light() +
  ggtitle("ASHR IRF of Trust on Volatility") +
  ylab("")+
  xlab("") +
  theme_minimal()
```
...
ggplot(Yd7,aes(x=period, y=cumsum(response))) +
  ...
  geom_line() +
  theme_light() +
  ggtitle("ASHR Cumulalitve IRF of Trust on Volatility") +
  ylab("")+
  xlab("") +
  theme_minimal()
```
...
```{r estimate surprise}
y8 = cbind(Vdata$prop_surprise, Vdata$ASHR_vol)
...
ggplot(Yd8,aes(x=period, y=response)) +
  ...
  geom_line() +
  theme_light() +
  ggtitle("ASHR IRF of Surprise on Volatility") +
  ylab("")+
  xlab("") +
  theme_minimal()
```
...
ggplot(Yd8,aes(x=period, y=cumsum(response))) +
  ...
  geom_line() +
  theme_light() +
  ggtitle("ASHR Cumulalitve IRF of Surprise on Volatility") +
  ylab("")+
  xlab("") +
  theme_minimal()
```
...
```{r estimate sadness}
y9 = cbind(Vdata$prop_sadness, Vdata$ASHR_vol)
...
ggplot(Yd9,aes(x=period, y=response)) +
  ...
  geom_line() +
  theme_light() +
  ggtitle("ASHR IRF of Sadness on Volatility") +
  ylab("")+
  xlab("") +
  theme_minimal()
```
...
```{r estimate joy}
y10 = cbind(Vdata$prop_joy, Vdata$ASHR_vol)
...
ggplot(Yd10,aes(x=period, y=response)) +
  ...
  geom_line() +
  theme_light() +
  ggtitle("ASHR IRF of Joy on Volatility") +
  ylab("")+
  xlab("") +
  theme_minimal()
```
...
ggplot(Yd10,aes(x=period, y=cumsum(response))) +
  ...
  geom_line() +
  theme_light() +
  ggtitle("ASHR Cumulalitve IRF of Joy on Volatility") +
  ylab("")+
  xlab("") +
  theme_minimal()
```
...
```{r estimate fear}
y32 = cbind(Vdata$prop_fear, Vdata$ASHR_vol)
...
ggplot(Yd32,aes(x=period, y=response)) +
  ...
  geom_line() +
  theme_light() +
  ggtitle("ASHR IRF of Fear on Volatility") +
  ylab("")+
  xlab("") +
  theme_minimal()
```
...
ggplot(Yd32,aes(x=period, y=cumsum(response))) +
  ...
  geom_line() +
  theme_light() +
  ggtitle("ASHR Cumulalitve IRF of Fear on Volatility") +
  ylab("")+
  xlab("") +
  theme_minimal()
```
...
```{r estimate disgust}
y11 = cbind(Vdata$prop_disgust, Vdata$ASHR_vol)
...
ggplot(Yd11,aes(x=period, y=response)) +
  ...
  geom_line() +
  theme_light() +
  ggtitle("ASHR IRF of Disgust on Volatility") +
  ylab("")+
  xlab("") +
  theme_minimal()
```
...
ggplot(Yd11,aes(x=period, y=cumsum(response))) +
  ...
  geom_line() +
  theme_light() +
  ggtitle("ASHR Cumulalitve IRF of Disgust on Volatility") +
  ylab("")+
  xlab("") +
  theme_minimal()
```
...
y15 = cbind(Vdata$prop_anticipation, Vdata$ASHR_vol)
...
ggplot(Yd15,aes(x=period, y=response)) +
  ...
  geom_line() +
  theme_light() +
  ggtitle("ASHR IRF of Anticipation on Volatility") +
  ylab("")+
  xlab("") +
  theme_minimal()
```
...
ggplot(Yd15,aes(x=period, y=cumsum(response))) +
  ...
  geom_line() +
  theme_light() +
  ggtitle("ASHR Cumulalitve IRF of Anticipation on Volatility") +
  ylab("")+
  xlab("") +
  theme_minimal()
```
...
```{r estimate anger}
y16 = cbind(Vdata$prop_anger, Vdata$ASHR_vol)
...
ggplot(Yd16,aes(x=period, y=response)) +
  ...
  geom_line() +
  theme_light() +
  ggtitle("ASHR IRF of Anger on Volatility") +
  ylab("")+
  xlab("") +
  theme_minimal()
```
...
ggplot(Yd16,aes(x=period, y=cumsum(response))) +
  ...
  geom_line() +
  theme_light() +
  ggtitle("ASHR Cumulalitve IRF of Anger on Volatility") +
  ylab("")+
  xlab("") +
  theme_minimal()
```
...
ggplot(Yd12,aes(x=period, y=response)) +
  ...
  geom_line() +
  theme_light() +
  ggtitle("ASHR IRF of N*Tariff on Volatility") +
  ylab("")+
  xlab("") +
  theme_minimal()
```
...
ggplot(Yd12,aes(x=period, y=cumsum(response))) +
  ...
  geom_line() +
  theme_light() +
  ggtitle("ASHR Cumulalitve IRF of N*tariff on Volatility") +
  ylab("")+
  xlab("") +
  theme_minimal()
```
...
y12.2 = cbind(y12.2, Vdata$ASHR_vol)
...
ggplot(Yd14,aes(x=period, y=response)) +
  ...
  geom_line() +
  theme_light() +
  ggtitle("ASHR IRF of N*Trade on Volatility") +
  ylab("")+
  xlab("") +
  theme_minimal()
```
...
ggplot(Yd14,aes(x=period, y=cumsum(response))) +
  ...
  geom_line() +
  theme_light() +
  ggtitle("ASHR Cumulalitve IRF of N*Trade on Volatility") +
  ylab("")+
  xlab("") +
  theme_minimal()
```
...
y14.2 = cbind(y14.2, Vdata$ASHR_vol)
...
y_f_n = cbind(Vdata_f$N, Vdata_f$ASHR_vol)
...
ggplot(Yd_f_n,aes(x=period, y=response)) +
  ...
  geom_line() +
  theme_light() +
  ggtitle("ASHR IRF of First Term N on Volatility") +
  ylab("")+
  xlab("") +
  theme_minimal()
```
...
ggplot(Yd_f_n,aes(x=period, y=cumsum(response))) +
  ...
  geom_line() +
  theme_light() +
  ggtitle("ASHR Cumulalitve IRF of First Mandate N on Volatility") +
  ylab("")+
  xlab("") +
  theme_minimal()
```
...
y_f_ta = cbind(Vdata_f$tariff, Vdata_f$ASHR_vol)
...
ggplot(Yd_f_ta,aes(x=period, y=response)) +
  ...
  geom_line() +
  theme_light() +
  ggtitle("ASHR IRF of First Term Tariff on Volatility") +
  ylab("")+
  xlab("") +
  theme_minimal()
```
...
ggplot(Yd_f_ta,aes(x=period, y=cumsum(response))) +
  ...
  geom_line() +
  theme_light() +
  ggtitle("ASHR Cumulalitve IRF of First Mandate Tariff on Volatility") +
  ylab("")+
  xlab("") +
  theme_minimal()
```
...
y_f_tr = cbind(Vdata_f$trade, Vdata_f$ASHR_vol)
...
ggplot(Yd_f_tr,aes(x=period, y=response)) +
  ...
  geom_line() +
  theme_light() +
  ggtitle("ASHR IRF of First Term Trade on Volatility") +
  ylab("")+
  xlab("") +
  theme_minimal()
```
...
ggplot(Yd_f_tr,aes(x=period, y=cumsum(response))) +
  ...
  geom_line() +
  theme_light() +
  ggtitle("ASHR Cumulalitve IRF of First Mandate Trade on Volatility") +
  ylab("")+
  xlab("") +
  theme_minimal()
```
...
y_f_ch = cbind(Vdata_f$china, Vdata_f$ASHR_vol)
...
ggplot(Yd_f_ch,aes(x=period, y=response)) +
  ...
  geom_line() +
  theme_light() +
  ggtitle("ASHR IRF of First Term China on Volatility") +
  ylab("")+
  xlab("") +
  theme_minimal()
```
...
ggplot(Yd_f_ch,aes(x=period, y=cumsum(response))) +
  ...
  geom_line() +
  theme_light() +
  ggtitle("ASHR Cumulalitve IRF of First Mandate China on Volatility") +
  ylab("")+
  xlab("") +
  theme_minimal()
```
...
y_s_n = cbind(Vdata_s$N, Vdata_s$ASHR_vol)
...
ggplot(Yd_s_n,aes(x=period, y=response)) +
  ...
  geom_line() +
  theme_light() +
  ggtitle("ASHR IRF of Second Term N on Volatility") +
  ylab("")+
  xlab("") +
  theme_minimal()
```
...
ggplot(Yd_s_n,aes(x=period, y=cumsum(response))) +
  ...
  geom_line() +
  theme_light() +
  ggtitle("ASHR Cumulalitve IRF of Second Mandate N on Volatility") +
  ylab("")+
  xlab("") +
  theme_minimal()
```
...
y_s_ta = cbind(Vdata_s$tariff, Vdata_s$ASHR_vol)
...
ggplot(Yd_s_ta,aes(x=period, y=response)) +
  ...
  geom_line() +
  theme_light() +
  ggtitle("ASHR IRF of Second Term Tariff on Volatility") +
  ylab("")+
  xlab("") +
  theme_minimal()
```
...
ggplot(Yd_s_ta,aes(x=period, y=cumsum(response))) +
  ...
  geom_line() +
  theme_light() +
  ggtitle("ASHR Cumulalitve IRF of Second Mandate Tariff on Volatility") +
  ylab("")+
  xlab("") +
  theme_minimal()
```
...
y_s_tr = cbind(Vdata_s$trade, Vdata_s$ASHR_vol)
...
ggplot(Yd_s_tr,aes(x=period, y=response)) +
  ...
  geom_line() +
  theme_light() +
  ggtitle("ASHR IRF of Second Term Trade on Volatility") +
  ylab("")+
  xlab("") +
  theme_minimal()
```
...
ggplot(Yd_s_tr,aes(x=period, y=cumsum(response))) +
  ...
  geom_line() +
  theme_light() +
  ggtitle("ASHR Cumulalitve IRF of Second Mandate Trade on Volatility") +
  ylab("")+
  xlab("") +
  theme_minimal()
```
...
y_s_ch = cbind(Vdata_s$china, Vdata_s$ASHR_vol)
...
ggplot(Yd_s_ch,aes(x=period, y=response)) +
  ...
  geom_line() +
  theme_light() +
  ggtitle("ASHR IRF of Second Term China on Volatility") +
  ylab("")+
  xlab("") +
  theme_minimal()
```
...
ggplot(Yd_s_ch,aes(x=period, y=cumsum(response))) +
  ...
  geom_line() +
  theme_light() +
  ggtitle("ASHR Cumulalitve IRF of Second Term China on Volatility") +
  ylab("")+
  xlab("") +
  theme_minimal()
```
