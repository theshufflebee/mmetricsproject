...
table_texreg <- texreg(
  ...
  custom.note = "This table displays VAR regression with only two variables : 
  AHV and the X regressor. The column names represent the X variable for the selected model."
)
...
table_texreg_f <- texreg(
  ...
  custom.note = "This table displays VAR regression with only two variables : AHV and the X regressor. The column names represent the X variable for the selected model."
)
