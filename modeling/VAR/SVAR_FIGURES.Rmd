...
table_texreg <- texreg(
  ...
  custom.note = c("This table displays VAR regression with only two variables : AHV and X regressor.", "The column names represent the X variable for the selected model.")
)
