...
armax(armax_data$SPY_vol,xreg=armax_data$N,nb.lags=0,latex=T)
...
armax(armax_data$SPY_vol,xreg=armax_data$dummy,nb.lags=3,latex=T)
...
armax(armax_data$SPY_vol,xreg=armax_data$total_tariff,nb.lags=5,latex=T)
...
armax(armax_data$SPY_vol,xreg=armax_data$prop_positive,nb.lags=2,latex=T)
...
armax(armax_data$VGK_vol,xreg=armax_data$N,nb.lags=0,latex=T)
...
armax(armax_data$VGK_vol,xreg=armax_data$dummy,nb.lags=3,latex=T)
...
armax(armax_data$VGK_vol,xreg=armax_data$total_tariff,nb.lags=5,latex=T)
...
armax(armax_data$VGK_vol,xreg=armax_data$prop_negative,nb.lags=0,latex=T)
...
armax(armax_data$ASHR_vol,xreg=armax_data$N,nb.lags=5,latex=T)
...
armax(armax_data$ASHR_vol,xreg=armax_data$dummy,nb.lags=5,latex=T)
...
armax(armax_data$ASHR_vol,xreg=armax_data$total_tariff,nb.lags=5,latex=T)
...
armax(armax_data$ASHR_vol,xreg=armax_data$prop_positive,nb.lags=3,latex=T)

```
## Negative Vibe on Volatility by hour
```{r ASHR ARMA-X negative hourly, results='asis'}

armax(armax_data$ASHR_vol,xreg=armax_data$prop_negative,nb.lags=5,latex=T)
