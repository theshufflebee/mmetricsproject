...
```
## Tweet TEMP on Daily Volatility
```{r ARMA-X duewemmy daily}

Xreg = as.matrix(countvol_day[3:4])

#find best armax model and fit
armax_dayfit <- select_armax(countvol_day$r_vol_d, Xreg, 
                       max_p = 5, max_q = 5, max_r = 5, criterion = "AIC")
