...
raw_SPYqy <- read.csv(here("data/market_data", "Spyqyahoo.csv"))
```
...
#market prices
day_SPY_0409 = filter(raw_SPYq, str_detect(timestamp, "^2025-04-09")) #9th of april
day_SPY_0409$timestamp = as.POSIXct(day_SPY_0409$timestamp, 
                                    format = "%Y-%m-%d %H:%M:%S", tz = "UTC")#+9
#day_SPY_0409$timestamp = with_tz(day_SPY_0409$timestamp, "UTC")

yahoo_ds0409 = filter(raw_SPYqy, str_detect(Date, "^2025-04-09"))
