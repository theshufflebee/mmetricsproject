...
#for each hour in each day of each month of any dataset
#works for datasets with more than 1 year!
vol_SPY = r.vol_hourly(raw_SPY,merge=F)
head(vol_SPY)
#can then filter out years, months, or days
vol_24 = year_selector(vol_SPY,2024)
vol_24_09 = month_selector(vol_SPY,2024,09)
vol_24_04_02 = day_selector(vol_SPY,2024,04,02)
...
#hours in a year
vol_plotter(vol_24,breaks="monthly",
...
vol_SPY = r.vol_hourly(raw_SPY,merge=F)
vol_VGK = r.vol_hourly(raw_VGK,merge=F)

vol_plotter(vol_SPY,breaks="yearly",title="SPY Volatility Since 2019")
