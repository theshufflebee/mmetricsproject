...
source(here("helperfunctions/r.vol_year.R"))
...
#data_loader(year=2024,months=1:12,symbol="SPY")
data_loader(year=2025,months=1:4,symbol="SPY")
data_loader(year=2024,months=1:12,symbol="VGK") #EU
data_loader(year=2025,months=1:4,symbol="VGK")
data_loader(year=2025,months=1:2,symbol="ASHR")


data_loader2(year=2024,months=1:12,"SPY")
...
day_SPY_0402 = day_selector(raw_SPY_2025_04,2025,04,02) #april 2nd 2025
...
month_hour = r.vol_month_hour(raw_SPY_2025_04)
...
#days in a month
plot(r.vol_month(raw_SPY_2025_04))
