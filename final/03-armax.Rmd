...
<span style="color:red"> *bigfigX* </span> that all the x-regressors are significant,
...
(<span style="color:red"> *smalldescfigX* </span>). We in fact predict that an 
...
<span style="color:red"> *bigtableX2* </span>, the first interesting result
...
On <span style="color:red"> *smalldescfigX* </span>, the pvalues being zero
