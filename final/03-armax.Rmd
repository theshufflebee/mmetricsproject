...
(<span style="color:red"> *ARMAX Table 4* </span>) \@ref(sec:SPYressum). We in fact predict that an 
...
On <span style="color:red"> *ARMAX Table 3* </span>, \@ref(sec:SPYressum) the pvalues being zero
