...
(<span style="color:red"> *ARMAX Table 4* </span>) \@ref(sec:SPYresmeans). We in fact predict that an 
...
On <span style="color:red"> *ARMAX Table 3* </span>, \@ref(sec:SPYres) the pvalues being zero
