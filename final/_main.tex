...
\includegraphics{_main_files/figure-latex/fin plots-1.pdf} \includegraphics{_main_files/figure-latex/fin plots-2.pdf}
...
\section{SPY Table (both terms)}\label{sec:spy-table}
