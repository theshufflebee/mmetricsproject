...
```{r armax1, results="asis", warning=F, message=F}
...
# Flattened coefficient names in the correct order — CHECK this matches your model structure!
xnames_ordered <- c(
  "AR(1)", "AR(2)", "AR(3)",
  "MA(1)", "MA(2)", "MA(3)",
  "Constant",
