...
kable(pvals, format = "html", digits = 4, caption = "Full Timeframe Ljung-Box Test p-values") %>%
...
## Descriptive Stats{#sec:SPYresmeans}

```{r means, message=F, warning=F, results="asis", echo=FALSE, cache=TRUE}
...
kable(means, format = "html", digits = 6, caption = "Full Timeframe Ljung-Box Test p-values") %>%
  kable_styling(bootstrap_options = c("striped", "hover", "condensed"), full_width = FALSE, position = "center")
