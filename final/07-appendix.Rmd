...
```{r means, message=F, warning=F, results="asis", cache=TRUE, echo=FALSE}
...
```{r table first term, message=FALSE, warning=FALSE, results='asis', cache=TRUE, echo=FALSE}
...
```{r third_table, message=FALSE, warning=FALSE, results='asis', cache=TRUE, echo=FALSE}
