...
### SPY ARMAX IRFs (Jan 2024 - May 2025){#sec:SPY-IRF}

```{r SPYirf, results="asis", warning=F, message=F, echo=FALSE, cache=FALSE}
...
```{r res-table, message=F, warning=F, results="asis", echo=FALSE, cache=FALSE}
