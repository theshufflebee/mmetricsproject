...
>>>>>>> 58fbf1175c82f0d1be2a6273d49ede48d786588a
---
...
```{r wordcould, results=FALSE, warning=FALSE, message=FALSE, cache=FALSE}
...
Section 2 Looks at the how the data was procured, what transformations were done
and how the final dataset looks like. Section three then shows methodology and
Results of ARMA-X estimations while Section 4 does the same for VAR models. Section
5 then discusses these results
