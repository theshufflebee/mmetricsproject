...
```{r fig1, fig.width=10, fig.height=5, echo=FALSE, fig.cap="Terminally Online: Trump's Twitter & Truth Social Posts (EDT)", warning=FALSE, cache=TRUE}
...
ggplot(SPY_comp,aes(x = day))+
  ...
  geom_line(aes(y = index_sp500, color = "S&P 500 Value")) +
  scale_color_manual(values = c("SPY Daily Close" = "blue", "S&P 500 Value" = "red")) +
  ...
  theme(
   ...
   # Add caption  
  labs(caption = str_wrap("To show that SPY tracks the S&P 500 almost perfectly, we've sourced the S&P 500 daily close from FRED and plotted it against our SPY closing Prices. The blue line that tracks the SPY ETF is barely visible", width = 100)) +
  theme(plot.caption = element_text(hjust = 0, face = "italic", size = 10))
