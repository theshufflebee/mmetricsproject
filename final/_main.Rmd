...
```{r social plots, fig.width=10, fig.height=5, fig.cap="Poster in Chief: Number of Social Media Posts with Mentions of Tariff", message=FALSE, warning=FALSE, echo=FALSE, cache=FALSE}
...
regressors. The assumption here is that, while the market reacts to Trump's posts,
Trump's posts are chaotic and random enough to be considered exogenous. 
...
a custom function in order to choose the number of lags ($p$, $q$ and $r$) based on the AIC criterion.
...
\@ref(sec:spy-table) that all the x-regressors are significant,
...
about 0.023 over the whole sample\@ref(sec:means-table). We in fact predict that an 
...
impulse response function (IRF) for this shock in Figure \@ref(sec:SPY-IRF) Notice that
...
now than before. We've found similar IRFs as for the full timeframe \@ref(sec:SPY-SPLIT-IRF). 
Finally, we check the residuals of all these models with Ljung-Box tests \@ref(sec:SPY-res-test). 
...
violating the exogeneity assumption that is critical for this type of model. With this
information, we decide to run SVAR specifications to account for possible endogeneity.
...
(\@ref(sec:irf-dummy), \@ref(sec:irf-cum-dummy)).
...
```{r datasetup_appendix, results=FALSE, warning=FALSE, message=FALSE, echo=FALSE, cache=FALSE}
...
```{r fitting models, results=F, warning=F, message=F, echo=FALSE, cache=FALSE}
...
```{r tab-armax-full, results="asis", warning=FALSE, echo=FALSE, message=FALSE, cache=FALSE}
library(texreg)
...
```{r fig-SPYirf, results="asis", warning=F, message=F, echo=FALSE, cache=FALSE}
...
```{r SPYres, warning=F, message=F, echo=FALSE, cache=FALSE}
...
```{r datasetup first, results=FALSE, warning=FALSE, message=FALSE, echo=FALSE, cache=FALSE}
...
```{r 1st term models, results=F, warning=F, message=F, echo=FALSE, cache=FALSE}
...
```{r 1st SPYresiduals, warning=F, message=F, results=F, echo=FALSE, cache=FALSE}
...
```{r datasetup second, results=FALSE, warning=FALSE, message=FALSE, echo=FALSE, cache=FALSE}
...
```{r 2nd term models, results=F, warning=F, message=F, echo=FALSE, cache=FALSE}
...
```{r 2nd SPYresiduals, results=F, warning=F, message=F, echo=FALSE, cache=FALSE}
...
```{r tab-armax-split, results="asis", warning=F, echo=FALSE, message=F, cache=FALSE}
...
```{r 2nd SPYirf, warning=F, message=F, echo=FALSE, cache=FALSE}
...
```{r tab-res-test, message=F, warning=F, results="asis", echo=FALSE, cache=FALSE}
...
```{r tab-means, message=F, warning=F, results="asis", cache=FALSE, echo=FALSE}
...
```{r Estime dummy, message=FALSE, warning=FALSE, echo=FALSE, cache=FALSE}
# Dummy Estimates
#-------------------------
...
```{r B mat, message=FALSE, warning=FALSE, echo=FALSE, cache=FALSE}
...
```{r IRF 1dummy, message=FALSE, warning=FALSE, echo=FALSE, cache=FALSE}
nb.sim = 7*7
...
```{r IRF 2Dummy, message=FALSE, warning=FALSE, echo=FALSE, cache=FALSE}
...
```{r estimate with N, message=FALSE, warning=FALSE, echo=FALSE, cache=FALSE}
...
```{r estime tariff, message=FALSE, warning=FALSE, echo=FALSE, cache=FALSE}
# Tariff Estimates
#---------------------
...
```{r B mat3, message=FALSE, warning=FALSE, echo=FALSE, cache=FALSE}
#Recreate a Robust Omega Matrix
...
```{r IRF tariffff, message=FALSE, warning=FALSE, echo=FALSE, cache=FALSE}
#get back the coefficient of est.VAR
phi3 <- Acoef(est.VAR3)
PHI3 = make.PHI(phi3)
...
### SVAR Cumultative IRF for Tariff{#sec:irf-cum-tariff}

```{r IRF tariff, message=FALSE, warning=FALSE, echo=FALSE, cache=FALSE}
...
```{r estimate trade, message=FALSE, warning=FALSE, echo=FALSE, cache=FALSE}
# Trade Estimates
#----------------------
...
```{r estime China, message=FALSE, warning=FALSE, echo=FALSE, cache=FALSE}
# Chinae Estimates
#---------------------
...
```{r mana, message=FALSE, warning=FALSE, echo=FALSE, cache=FALSE}
# Full Timeframe Table Preparation
#-----------------------------------
dt_t = d %>%
...
```{r datasetup2, results=FALSE, warning=FALSE, message=FALSE, cache=FALSE, echo=FALSE}
data <- c(0)
data <- backup
#source(here("helperfunctions/full_data.R"))
...
```{r first mandate dum, warning=FALSE, message=FALSE, results="asis", cache=FALSE, echo=FALSE}
...
```{r first mandate N, warning=FALSE, message=FALSE, results="asis", cache=FALSE, echo=FALSE}
...
```{r first mandate tariff, warning=FALSE, message=FALSE, results="asis", cache=FALSE, echo=FALSE}
...
```{r first mandate trade, warning=FALSE, message=FALSE, results="asis", cache=FALSE, echo=FALSE}
# Trade FIrst Mandate
#------------------------
...
```{r first mandate china, warning=FALSE, message=FALSE, results="asis", cache=FALSE, echo=FALSE}
# China First Mandate
#-----------------------
...
```{r second mandate dum, warning=FALSE, message=FALSE, results="asis", cache=FALSE, echo=FALSE}
# Second term
#---------------------
...
```{r second mandate N, warning=FALSE, message=FALSE, results="asis", cache=FALSE, echo=FALSE}
...
```{r second mandate tariff, warning=FALSE, message=FALSE, results="asis", cache=FALSE, echo=FALSE}
# Tariff
#-------------
...
```{r second mandate trade, warning=FALSE, message=FALSE, results="asis", cache=FALSE, echo=FALSE}
# Trade
#----------
...
```{r second mandate china, warning=FALSE, message=FALSE, results="asis", cache=FALSE, echo=FALSE}
# China
#--------------
...
```{r B mat second mandate china, warning=FALSE, message=FALSE, cache=FALSE, echo=FALSE}
...
```{r IRF second china, warning=FALSE, message=FALSE, cache=FALSE, echo=FALSE}
#get back the coefficient of est.VAR
...
```{r IRF _s_ch, cache=FALSE, echo=FALSE}
...
```{r tab-second-var, message=FALSE, warning=FALSE, results='asis', cache=FALSE, echo=FALSE}
...
```{r tab-third-var, message=FALSE, warning=FALSE, results='asis', cache=FALSE, echo=FALSE}
