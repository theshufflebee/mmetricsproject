...
```{r fig social plots, fig.width=10, fig.height=5, fig.cap="Poster in Chief: Number of Social Media Posts with Mentions of Tariff", message=FALSE, warning=FALSE, echo=FALSE, cache=FALSE}
