...
res = checkresiduals(models[["First Term (1)"]], plot = FALSE)
res = checkresiduals(models[["First Term (2)"]], plot = FALSE)
res = checkresiduals(models[["First Term (3)"]], plot = FALSE)
...
res = checkresiduals(models[["Second Term (1)"]], plot = FALSE)
res = checkresiduals(models[["Second Term (2)"]], plot = FALSE)
res = checkresiduals(models[["Second Term (3)"]], plot = FALSE)
