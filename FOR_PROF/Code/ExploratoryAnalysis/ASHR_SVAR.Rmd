...
```{r Estime dummy, results=FALSE, warning=FALSE, results="asis"}
...
```{r B mat, results=FALSE, warning=FALSE}
...
```{r Estime N, results=FALSE, warning=FALSE, results="asis"}
...
```{r B mat2, results=FALSE, warning=FALSE}
...
```{r Estime tariff, results=FALSE, warning=FALSE, results="asis"}
...
```{r B mat3, results=FALSE, warning=FALSE}
...
```{r Estime trade, results=FALSE, warning=FALSE, results="asis"}
...
```{r B mat4, results=FALSE, warning=FALSE}
...
```{r Estime china, results=FALSE, warning=FALSE, results="asis"}
y5 = cbind(Vdata$china , Vdata$ASHR_vol)
...
```{r B mat5, results=FALSE, warning=FALSE}
...
```{r B mat12, results=FALSE, warning=FALSE}
...
y_f_d = cbind(Vdata_f$tariff, Vdata_f$ASHR_vol)
...
```{r B mat first mandate, results=FALSE, warning=FALSE}
...
y_s_d = cbind(Vdata_s$tariff, Vdata_s$ASHR_vol)
...
```{r B mat second mandate, results=FALSE, warning=FALSE}
