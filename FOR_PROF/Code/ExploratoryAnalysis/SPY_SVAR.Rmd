...
```{r dummy, warning=FALSE, message=FALSE, results="asis"}
...
```{r post numbers, warning=FALSE, message=FALSE, results="asis"}
...
```{r tariff, warning=FALSE, message=FALSE, results="asis"}
...
```{r trade, warning=FALSE, message=FALSE, results="asis"}
...
```{r china, warning=FALSE, message=FALSE, results="asis"}
...
# Post Count and Tariff Mention Interaction

Here is an example of adding interaction terms. 

```{r Interaction, warning=FALSE, message=FALSE, results="asis"}
...
```{r first mandate, warning=FALSE, message=FALSE, results="asis"}

y_f_d = cbind(Vdata_f$tariff, Vdata_f$SPY_vol)
...
y_s_d = cbind(Vdata_s$tariff, Vdata_s$SPY_vol)
...
```{r B mat second mandate, warning=FALSE, message=FALSE}
