...
# Setup
```{r library_setup, results=FALSE, warning=FALSE, message=FALSE, eval=TRUE}
rm(list=ls())
...
```{r rawdata_setup, results=FALSE, warning=FALSE, message=FALSE, eval=TRUE}
...
```{r cleanup, results=FALSE, warning=FALSE, message=FALSE, eval=TRUE}
...
Here's the plot we use in our introduction, showing the endless stream of Trump's
social media presence.
```{r fig1, warning=FALSE, fig.cap="Terminally Online: Trump's Twitter & Truth Social Posts (EDT)"}
